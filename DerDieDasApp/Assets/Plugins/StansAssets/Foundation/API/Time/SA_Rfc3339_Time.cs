...
namespace SA.Foundation.Time
{
    ...
    {
        static string[] _rfc3339Formats = new string[0];
        const string Rfc3339Format = "yyyy-MM-dd'T'HH:mm:ssK";
        const string MinRfc339Value = "0001-01-01T00:00:00Z";
        ...
        static string[] DateTimePatterns
        {
            get
            {
                if (_rfc3339Formats.Length > 0) return _rfc3339Formats;
