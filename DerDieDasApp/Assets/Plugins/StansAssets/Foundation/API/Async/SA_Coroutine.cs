...
namespace SA.Foundation.Async
{
    public static class SA_Coroutine
    {
        ...
        class SA_InternalCoroutine : SA_Singleton<SA_InternalCoroutine>
        {
        ...
        class CoroutineQueue : SA_Singleton<CoroutineQueue>
        {
            readonly Queue<IEnumerator> m_coroutineQueue = new Queue<IEnumerator>();
