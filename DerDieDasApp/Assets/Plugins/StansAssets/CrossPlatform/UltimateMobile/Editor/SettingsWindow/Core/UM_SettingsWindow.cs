...
namespace SA.CrossPlatform.Editor
{
    class UM_SettingsWindow : SA_PluginSettingsWindow<UM_SettingsWindow>
    {
        ...
        const int TOOLBAR_BUTTONS_HEIGHT = 19;
        const int TOOLBAR_BUTTONS_SPACE = -10;

        const string DESCRIPTION = "The Ultimate plugin for the mobile development and more. " +
        ...
        [SerializeField]
        SA_HyperToolbar m_pluginsToolbar;

        [SerializeField]
        SA_HyperLabel m_backLink;
        [SerializeField]
