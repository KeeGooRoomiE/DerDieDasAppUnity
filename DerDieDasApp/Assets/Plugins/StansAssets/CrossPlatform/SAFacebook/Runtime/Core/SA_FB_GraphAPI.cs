...
namespace SA.Facebook
{
    public class SA_FB_GraphAPI
    {
        ...
        /// <see href="https://developers.facebook.com/docs/graph-api/reference/v2.2/user/invitable_friends"/> for information </para>
        /// </summary>
        /// <param name="limit">Result limit </param>
        /// <param name="callback">Request callback </param>
        /// <param name="cursor">Pagination cursor pointer </param>
        public void GetInevitableFriends(int limit, Action<SA_FB_GraphInvitableFriendsListResult> callback, SA_FB_Cursor cursor = null)
        {
        ...
        {
            var request = new SA_FB_RequestBuilder($"/{id}?fields=picture.type({size})");
            SA_FB.API(request.RequestString, HttpMethod.GET,
                graphResult =>
                {
