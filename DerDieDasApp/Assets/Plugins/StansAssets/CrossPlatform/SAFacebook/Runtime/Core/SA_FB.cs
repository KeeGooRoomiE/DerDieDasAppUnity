...
namespace SA.Facebook
{
    ...
    {
        static readonly SA_FB_GraphAPI m_graphAPI = new SA_FB_GraphAPI();
        ...
        static void Login(List<string> scopes, Action<SA_FB_LoginResult> callback)
        {
        ...
        public static void API(string query, HttpMethod method, FacebookDelegate<IGraphResult> callback = null, IDictionary<string, string> formData = null)
        {
            SA_FB_LoginUtil.ConfirmLoginStatus((statusResult) =>
            {
                ...
                {
                    if (callback != null) callback.Invoke(statusResult);
                }
            });
        }
        ...
        /// </summary>
        public static bool IsLoggedIn => SA_FB_Proxy.IsLoggedIn;

        /// <summary>
        /// Check whether the Unity SDK has been initialized. false if the SDK has not been initalized.
        /// </summary>
        public static bool IsInitialized => SA_FB_Proxy.IsInitialized;

        /// <summary>
        /// Object that contain methods to comunicate with facebook graph API
        /// </summary>
        public static SA_FB_GraphAPI GraphAPI => m_graphAPI;
        ...
        /// </summary>
        public static SA_AccessToken AccessToken => SA_AccessToken.CurrentAccessToken;
        ...
        /// </summary>
        public static string ClientToken => SA_FB_Proxy.ClientToken;
    }
}
