...
public class SA_FB_UseExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!SA_FB_Settings.Instance.Scopes.Contains("email")) SA_FB_Settings.Instance.Scopes.Add("email");

        if (!SA_FB_Settings.Instance.Scopes.Contains("user_gender")) SA_FB_Settings.Instance.Scopes.Add("user_gender");

        if (!SA_FB_Settings.Instance.Scopes.Contains("user_location")) SA_FB_Settings.Instance.Scopes.Add("user_location");

        if (!SA_FB_Settings.Instance.Scopes.Contains("user_age_range")) SA_FB_Settings.Instance.Scopes.Add("user_age_range");
    ...
    void SetUserInfoUI(SA_FB_User user)
    {
