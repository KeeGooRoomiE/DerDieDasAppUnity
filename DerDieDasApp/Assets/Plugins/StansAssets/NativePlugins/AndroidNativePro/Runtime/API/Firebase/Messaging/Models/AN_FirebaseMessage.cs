...
namespace SA.Android.Firebase.Messaging
{
    ...
    {
	    readonly string m_collapseKey = string.Empty;
	    readonly string m_error = string.Empty;
	    readonly string m_errorDescription = string.Empty;
	    readonly string m_from = string.Empty;
	    readonly string m_messageId = string.Empty;
	    readonly string m_messageType = string.Empty;
	    readonly bool m_notificationOpened = false;
	    readonly string m_priority = string.Empty;
	    readonly string m_rawData = string.Empty;
	    readonly string m_to = string.Empty;
        ...
        /// </summary>
        public string CollapseKey => m_collapseKey;
        ...
        /// This field is only used for downstream messages received through the FirebaseMessaging.MessageReceived event.
        /// </summary>
        public string ErrorDescription => m_errorDescription;
        ...
        /// </summary>
        public bool NotificationOpened => m_notificationOpened;
        ...
        /// This field is only used for downstream messages received through the FirebaseMessaging.MessageReceived event.
        /// </summary>
        public string Priority => m_priority;
