...
namespace SA.Android.GMS.Games.Multiplayer
{
    ...
    public class AN_Participant
    {
        ...
        [SerializeField]
        string m_ParticipantId = string.Empty;
        [SerializeField]
        AN_Player m_Player = null;
        [SerializeField]
        AN_ParticipantResult m_Result = null;
        [SerializeField]
        int m_Status = 0;
        [SerializeField]
        bool m_IsConnectedToRoom = false;
        ...
        /// </summary>
        public AN_Player Player => m_Player;
        ...
        /// </summary>
        public AN_ParticipantResult Result => m_Result;
        ...
        /// </summary>
        public bool IsConnectedToRoom => m_IsConnectedToRoom;
    }
}
