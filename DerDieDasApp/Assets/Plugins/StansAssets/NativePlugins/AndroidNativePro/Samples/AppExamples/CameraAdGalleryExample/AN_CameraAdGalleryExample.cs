...
#pragma warning disable 649
    ...
    [Header("Camera")]
    [SerializeField]
    Button m_captureAdvanced;

    //[SerializeField] Button m_nativeCapture;
    [SerializeField]
    Button m_captureVideo;

    [Header("Gallery")]
    [SerializeField]
    Button m_getPictures;
    [SerializeField]
    Button m_getVideos;
    [SerializeField]
    Button m_getMixed;
...
#pragma warning restore 649
        ...
        m_saveScreenshot.onClick.AddListener(() =>
        {
            SA_ScreenUtil.TakeScreenshot(512, (screenshot) =>
            {
                AN_Gallery.SaveImageToGallery(screenshot, "ExampleScreenshot", (result) =>
                {
                    ...
                    Debug.Log("Screenshot has been saved to:  " + result.Path);
                });
            });
        });
    }
    ...
    void PrintCaptureResult(AN_CameraCaptureResult result)
    {
        ...
        Debug.Log("result.Media.Thumbnail: " + result.Media.Thumbnail);
